...
function activate(context) {
    ...
    console.log('Congratulations, your extension "ai-extension-practice" is now active!');
    const disposable = vscode.commands.registerCommand('ai-extension-practice.helloWorld', () => {
        HelloWorldPanel_1.HelloWorldPanel.createOrShow(context.extensionUri);
    });
    context.subscriptions.push(disposable);
    context.subscriptions.push(vscode.commands.registerCommand('ai-extension-practice.askQuestion', async () => {
        const res = await vscode.window.showInformationMessage('How was your day?', 'good', 'bad');
        if (res === 'good') {
            vscode.window.showInformationMessage('Oh Super');
        }
        else if (res === 'bad') {
            vscode.window.showInformationMessage('What\'s happening');
        }
        else {
            console.log(res);
        }
